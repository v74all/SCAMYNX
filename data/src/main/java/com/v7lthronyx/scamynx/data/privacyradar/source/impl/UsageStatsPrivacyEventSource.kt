...
@Singleton
class UsageStatsPrivacyEventSource @Inject constructor(
    @ApplicationContext context: Context,
    @IoDispatcher private val dispatcher: CoroutineDispatcher,
) : PrivacyEventSource {

    override val id: PrivacyEventSourceId = PrivacyEventSourceId("usage_stats")
    override val supportedResources: Set<PrivacyResourceType> = setOf(
        PrivacyResourceType.FOREGROUND_SERVICE,
        PrivacyResourceType.LOCATION,
        PrivacyResourceType.OTHER,
    )
